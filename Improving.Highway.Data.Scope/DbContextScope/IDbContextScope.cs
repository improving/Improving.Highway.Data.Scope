...
namespace Improving.Highway.Data.Scope.DbContextScope
{
    ...
    public delegate void DbContextScopeDidSave(IDbContextScope scope, int count);
    ...
    public interface IDbContextScope : IDisposable
    {
        ...
        /// </summary>
        int SaveChanges(DbContextScopeDidSave didSave = null);

        /// <summary>
        /// Saves the changes in all the DbContext instances that were created within this scope.
        /// This method can only be called once per scope.
        /// </summary>
        Task<int> SaveChangesAsync(DbContextScopeDidSave didSave = null);

        /// <summary>
        /// Saves the changes in all the DbContext instances that were created within this scope.
        /// This method can only be called once per scope.
        /// </summary>
        Task<int> SaveChangesAsync(CancellationToken cancelToken, DbContextScopeDidSave didSave = null);
