...
namespace Improving.Highway.Data.Scope.DbContextScope
{
    ...
    public class DbContextScope : IDbContextScope
    {
        ...
        public event DbContextScopeDidSave DidSave
        {
            add
            {
                if (_nested)
                    _parentScope.DidSave += value;
                else
                    _didSave += value;
            }
        ...
        private DbContextScopeDidSave _didSave;

        public int SaveChanges(DbContextScopeDidSave didSave = null)
        {
            if (_disposed)
        ...
        public Task<int> SaveChangesAsync(DbContextScopeDidSave didSave = null)
        {
            return SaveChangesAsync(CancellationToken.None, didSave);
        }

        public async Task<int> SaveChangesAsync(CancellationToken cancelToken, DbContextScopeDidSave didSave = null)
        {
            if (cancelToken == null)
